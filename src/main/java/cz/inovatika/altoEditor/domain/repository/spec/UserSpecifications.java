...
public class UserSpecifications {
    ...
    public static Specification<User> isKramerius(Boolean isKramerius) {
        return (root, query, cb) -> isKramerius == null ? null : cb.equal(root.get("kramerius"), isKramerius);
    }

    public static Specification<User> isEngine(Boolean isEngine) {
        return (root, query, cb) -> isEngine == null ? null : cb.equal(root.get("engine"), isEngine);
    }

    public static Specification<User> isEnabled(Boolean isEnabled) {
        return (root, query, cb) -> isEnabled == null ? null : cb.equal(root.get("enabled"), isEnabled);
    }
}
