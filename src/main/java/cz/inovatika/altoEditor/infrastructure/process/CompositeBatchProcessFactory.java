...
import cz.inovatika.altoEditor.infrastructure.process.accept.AcceptVersionsProcessFactory;
...
public class CompositeBatchProcessFactory implements BatchProcessFactory {
    ...
    private final AcceptVersionsProcessFactory acceptVersionsProcessFactory;
